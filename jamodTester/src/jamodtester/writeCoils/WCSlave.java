...
public class WCSlave extends javax.swing.JFrame {
    ...
    {
        private void checkfun(JLabel label,int coil)
        {
            if (ModbusCoupler.getReference().getProcessImage().getDigitalOut(coil).isSet())
    ...
    private void initComponents() {
        ...
        jPanel3.add(coil0, gridBagConstraints);
    ...
    private javax.swing.JLabel coil0;
